...
function installDeps(dependencies, prefix) {
  return __async(this, null, function* () {
    ...
    yield (0, import_goods.spinner)(
      `npm i ${packages.join(" ")}`,
      () => import_core.$`npm install --no-save --no-audit --no-fund ${flags} ${packages}`.nothrow()
    );
  });
}
